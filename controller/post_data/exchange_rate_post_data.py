...
from controller.controller_error.post_data_error import WrongExchangeRatesBody

class ExchangeRatePostData(BasePostData):
    ...
    def check_base_currency_code_value(self) -> None:
        if BasePostData.is_empty_str(self._parameters_dict['baseCurrencyCode']):
            raise WrongExchangeRatesBody(
    ...
    def check_target_currency_code_value(self) -> None:
        if BasePostData.is_empty_str(self._parameters_dict['targetCurrencyCode']):
            raise WrongExchangeRatesBody(
